...
This is an experimental feature.  Enable it by launching `csd` with flags:

    csd -experimentalfeatures -paymentdisclosure -debug=paymentdisclosure -txindex=1

These flags can also be set as options in `cs.conf`.
...
[1] https://github.com/Mauricio503/zips/pull/119

### Example Use Case

Alice the customer sends 10 CS to Bob the merchant at the shielded address shown on their website.  However, Bob is not sure if he received the funds.
...
Generate a payment disclosure for the first joinsplit, second output (index starts from zero):
    ...
    cs-cli z_getpaymentdisclosure 79189528d611e811a1c7bb0358dd31343033d14b4c1e998d7c4799c40f8b652b 0 1 "Hello"
...
To validate the payment disclosure:
    ...
    cs-cli z_validatepaymentdisclosure HEXDATA
